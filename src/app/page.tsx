    ...
    <main className="flex flex-col min-h-screen bg-gray-100">
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-2xl font-bold text-white bg-rose-500 rounded-lg p-2">Hot Sale</h2>
          <Link href="/products/hot-sale" className="text-primary hover:underline font-medium">
            Xem tất cả
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex justify-between items-center mb-6">
              ...
              <Link href="/products/new" className="text-primary hover:underline font-medium">
                Xem tất cả
              </Link>
            </div>
...
function CategoryCarousel() {
  const categories = [
    { id: 1, name: "CPU", image: "/images/cpu.webp" },
    { id: 2, name: "GPU", image: "/images/vga.jpg" },
    { id: 3, name: "Bo mạch chủ", image: "/images/motherboard.jpeg" },
    { id: 4, name: "RAM", image: "/images/ram.png" },
    { id: 5, name: "Màn hình", image: "/images/monitor.webp" },
    { id: 6, name: "Nguồn máy tính", image: "/images/psu.jpg" },
    { id: 7, name: "SSD", image: "/images/ssd.webp" },
    { id: 8, name: "Vỏ case", image: "/images/case.jpg" },
  ];
