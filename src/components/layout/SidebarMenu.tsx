...
const SidebarMenu: React.FC = () => {
    ...
    return (
        <div className="bg-white rounded-lg shadow-md p-2 h-full">
            <h3 className="font-medium text-zinc-900 p-3 border-b mb-2">Danh mục sản phẩm</h3>
                ...
                {productCategories.map((category, idx) => (
                    <div key={idx} 
                        ...
                        >
                            ...
                            <ChevronRightIcon className={`transition-transform ${expandedCategory === idx ? 'rotate-90' : ''}`} />
                        </div>
