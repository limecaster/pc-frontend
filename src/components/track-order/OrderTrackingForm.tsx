...
import { trackOrder, verifyAndTrackOrder, requestOrderTrackingOTP, verifyOrderTrackingOTP } from "@/api/order";
...
const OrderTrackingForm: React.FC = () => {
    ...
    const [verificationStep, setVerificationStep] = useState<'orderId' | 'email' | 'otp'>('orderId');
                        ...
                        toast((t) => (
                            <div className="flex items-center bg-blue-50 p-4 rounded shadow-md">
                                ...
                                <div className="text-blue-700">
                                    <p className="font-medium">Vui lòng xác thực email để xem chi tiết đơn hàng</p>
                                </div>
                                <button onClick={() => toast.dismiss(t.id)} className="ml-auto text-blue-500 hover:text-blue-700">
                        ...
                        {verificationStep === 'orderId' && (
                            <div className="mb-6">
                                ...
                                <p className="text-sm text-gray-600 mt-2">
                                    * Nhập mã đơn hàng của bạn để kiểm tra tình trạng giao hàng
                                </p>
                            </div>
                        )}
                        ...
                        {verificationStep === 'email' && (
                            <div className="mb-6">
                                <div className="flex items-center mb-3">
                                    ...
                                    <span className="flex-1 text-center font-medium">Xác thực đơn hàng #{orderId}</span>
                                </div>
                                ...
                                <div className="mb-1">
                                    <input
                                        ...
                                        placeholder={maskedEmail ? `Ví dụ: ${maskedEmail}` : "Nhập email đã dùng khi đặt hàng"}
                                        className={`w-full px-4 py-2 border rounded-md focus:ring-primary focus:border-primary ${
                                            emailError
                                                ? "border-red-500"
                                                : "border-gray-300"
                                ...
                                {maskedEmail && (
                                    <p className="text-xs text-gray-600 mb-3">
                                        * Gợi ý: Email được sử dụng khi đặt hàng có dạng {maskedEmail}
                                    </p>
                                )}
                        ...
                        {verificationStep === 'otp' && (
                            <div className="mb-6">
                                <div className="flex items-center mb-3">
                                    ...
                                    <span className="flex-1 text-center font-medium">Nhập mã xác thực</span>
                                </div>
